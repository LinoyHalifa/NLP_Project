...
# CONFIG
# ===============================
INPUT_FILE = "D:\MS.c\MS.c\Yehudit\Clickbait_Detection_Project\ClickbaitTacticsDetection\Dataset_generation\clickbait_generated_train_val.csv"
OUTPUT_GT_FILE = "clickbait_train_val_GT_shuffled.csv"
RANDOM_SEED = 42
